...
(if cscope-list-entry-keymap
  ...
  (define-key cscope-list-entry-keymap "\C-cs" 'cscope-find-this-symbol)
  (define-key cscope-list-entry-keymap "\C-cd" 'cscope-find-this-symbol)
  (define-key cscope-list-entry-keymap "\C-cg" 'cscope-find-global-definition)
  (define-key cscope-list-entry-keymap "\C-cG"
    'cscope-find-global-definition-no-prompting)
  (define-key cscope-list-entry-keymap "\C-cc" 'cscope-find-functions-calling-this-function)
  (define-key cscope-list-entry-keymap "\C-cC" 'cscope-find-called-functions)
  (define-key cscope-list-entry-keymap "\C-ct" 'cscope-find-this-text-string)
  (define-key cscope-list-entry-keymap "\C-ce" 'cscope-find-egrep-pattern)
  (define-key cscope-list-entry-keymap "\C-cf" 'cscope-find-this-file)
  (define-key cscope-list-entry-keymap "\C-ci" 'cscope-find-files-including-file)
  ...
  ;; ---
  (define-key cscope-list-entry-keymap "\C-ca" 'cscope-set-initial-directory)
  (define-key cscope-list-entry-keymap "\C-cA" 'cscope-unset-initial-directory)
  ;; ---
  (define-key cscope-list-entry-keymap "\C-cL" 'cscope-create-list-of-files-to-index)
  (define-key cscope-list-entry-keymap "\C-cI" 'cscope-index-files)
  (define-key cscope-list-entry-keymap "\C-cE" 'cscope-edit-list-of-files-to-index)
  (define-key cscope-list-entry-keymap "\C-cW" 'cscope-tell-user-about-directory)
  (define-key cscope-list-entry-keymap "\C-cS" 'cscope-tell-user-about-directory)
  (define-key cscope-list-entry-keymap "\C-cT" 'cscope-tell-user-about-directory)
  (define-key cscope-list-entry-keymap "\C-cD" 'cscope-dired-directory)
...
(if cscope:map
  ...
  (define-key cscope:map "\C-cg" 'cscope-find-global-definition)
  ...
  (define-key cscope:map "\C-cC" 'cscope-find-called-functions)
  (define-key cscope:map "\C-ct" 'cscope-find-this-text-string)
  (define-key cscope:map "\C-ce" 'cscope-find-egrep-pattern)
  ...
  (define-key cscope:map "\C-cB" 'cscope-display-buffer-toggle)
  ...
  ;; ---
  (define-key cscope:map "\C-ca" 'cscope-set-initial-directory)
  (define-key cscope:map "\C-cA" 'cscope-unset-initial-directory)
  ;; ---
  (define-key cscope:map "\C-cL" 'cscope-create-list-of-files-to-index)
  (define-key cscope:map "\C-cI" 'cscope-index-files)
  (define-key cscope:map "\C-cE" 'cscope-edit-list-of-files-to-index)
  (define-key cscope:map "\C-cW" 'cscope-tell-user-about-directory)
  (define-key cscope:map "\C-cS" 'cscope-tell-user-about-directory)
  (define-key cscope:map "\C-cT" 'cscope-tell-user-about-directory)
  (define-key cscope:map "\C-cD" 'cscope-dired-directory))
  ;; The previous line corresponds to be end of the "Cscope" menu.
...
(defun cscope-prompt-for-symbol (prompt extract-filename)
  ...
  (let (sym)
    ...
    (if (or (not sym)
        ...
        (setq sym (if (equal "" (setq entry (read-from-minibuffer (concat prompt "(" sym "):")))) sym entry))
      sym)
    ))
