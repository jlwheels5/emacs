...
(defconst ecb-cscope-buffer-name "*cscope*")

(defecb-window-dedicator-to-ecb-buffer ecb-set-cscope-buffer
    ecb-cscope-buffer-name t
  "Display the Cscope-buffer in current window and make window
dedicated to the cscope buffer."
